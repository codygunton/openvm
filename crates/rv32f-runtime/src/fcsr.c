...
// For bare-metal RISC-V using SoftFloat, we don't need hardware FPU support
// Define our own constants and stub functions instead of using fenv.h
#ifdef __riscv
// Rounding mode constants (matching C99 fenv.h semantics)
#define FE_TONEAREST  0
#define FE_TOWARDZERO 1
#define FE_DOWNWARD   2
#define FE_UPWARD     3

// Exception flag constants (matching C99 fenv.h semantics)
...
// Stub implementations for fenv functions
// These are no-ops since we're using SoftFloat, not hardware FPU
...
#else
// For non-RISC-V targets, use standard fenv.h
#include <fenv.h>
#endif
